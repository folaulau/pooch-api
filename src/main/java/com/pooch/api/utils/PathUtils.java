...
public final class PathUtils {
    ...
    public static final String[] PUBLIC_URLS      = {"/groomers/service/types","/groomers/search", "/groomers/search/", "/phonenumbers/request-verification", "/phonenumbers/verification"};
