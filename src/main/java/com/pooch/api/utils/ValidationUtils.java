...
public class ValidationUtils {
  ...
  private static final String EMAIL_PATTERN = ALL_CHARS_WITH_NO_SPACE + "+" + AT_SYMBOL
      + LETTERS_AND_NUMBERS + "+" + DOT + "+(" + LETTERS_AND_NUMBERS + "+)";
  ...
  /**
   * String specialChars = "(.*[,~,!,@,#,$,%,^,&,*,(,),-,_,=,+,[,{,],},|,;,:,<,>,/,?].*$)"; <br>
   * Criteria Be 8-20 characters long<br>
  ...
  public static Boolean isValidPassword(String password) {
    ...
    if (password == null || password.isEmpty()) {
      ...
      result = pattern.matcher(password.trim()).matches();
