...
public class PoochApiApplication implements CommandLineRunner {
  ...
  public static void main(String[] args) {
    ...
    SpringApplication.run(PoochApiApplication.class, args);
  }
  ...
  public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
    return args -> {
      ...
      try {
        ...
        System.out.println("** API Url: http://" + env.getProperty("project.host") + ":"
            + hasuraServerPort + "/v1/api");
        System.out.println("** Console Url: http://" + env.getProperty("project.host") + ":"
            + hasuraServerPort + "/console");
        System.out.println("** Health Check Url: http://" + env.getProperty("project.host") + ":"
            + hasuraServerPort + "/healthz");
        System.out.println();
