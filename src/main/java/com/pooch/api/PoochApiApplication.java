...
public class PoochApiApplication {
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println(
						"** API Url: http://" + env.getProperty("project.host") + ":" + hasuraServerPort + "/v1/api");
				System.out.println("** Console Url: http://" + env.getProperty("project.host") + ":" + hasuraServerPort
						+ "/console");
