...
public interface EmailUtils {
  ...
  static String subValues(Map<String, String> params, String templateContent) {
    ...
    // Normally mustache reads templates from a resource directory. Here we want to pass inline
    // template as a
    // string. Hence use StringReader.
    Mustache mustache =
        mustacheFactory.compile(inlineTemplateReader, "populateEmailTemplateUsingMustache");
